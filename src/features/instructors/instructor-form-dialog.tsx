...
import { instructorFormRawSchema } from "@/lib/ski-school/schemas";
                ...
                <fieldset className="grid gap-2 rounded-md border px-3 py-2">
                  ...
                  <label className="flex cursor-pointer items-center gap-2 text-xs">
                    <input
                      ...
                      onChange={(e) => skiField.handleChange(e.target.checked)}
                  ...
                  <label className="flex cursor-pointer items-center gap-2 text-xs">
                    <input
                      ...
                      onChange={(e) => sbField.handleChange(e.target.checked)}
                      className="size-3.5 rounded-sm border-input accent-primary"
                    />
                    Snowboard
                  </label>
